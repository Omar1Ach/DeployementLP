        ...
        <nav className="container  flex h-[70px] items-center justify-between py-2 ">
          <div className="text-2xl text-white md:text-3xl ">
            <a href="/#home" className="">
              Tech
              <span className="inline-block font-bold text-primary">Sol</span>
            </a>
          </div>
          {/* Desktop Menu */}
                  ...
                  <div className="grid grid-cols-3 gap-5 ">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-sm text-slate-600">
                        Discover our range of top-selling services designed to
                        meet your needs. Our solutions are crafted with the
                        latest technology to ensure the best performance and
                        user experience.
                      </p>
                      <div className="grid grid-cols-3 ">
                        ...
                        <div>
                          <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085" alt="Tech Deployment Service 2" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <li>
                  <div>
                    ...
                    <p className="text-lg">
                      {" "}
                      <a href="tel:+212 618646886">+212 618646886</a>
                    </p>
                  </div>
                </li>
              </div>
